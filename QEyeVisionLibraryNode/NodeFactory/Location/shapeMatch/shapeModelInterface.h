...
namespace qv
{
    class ShapeModelInterface : public rv::IShapeModel
    {
    public:
    ...
    private:
        cv::Ptr<rv::IShapeModel> IShapeModel = nullptr;
        cv::Ptr<rv::MatchInterface> MatchInterface = nullptr;
    };

}

BOOST_SERIALIZATION_SPLIT_FREE(qv::ShapeModelInterface)
...
namespace boost
{
    namespace serialization
    {
        ...
        void save(Archive& ar, const ::qv::ShapeModelInterface& model, const unsigned int version)
        {
        ...
        template <class Archive>
        void load(Archive& ar, ::qv::ShapeModelInterface& model, const unsigned int version)
        {
            bool isCreated;
