...
namespace rv
{
    class GenericShapeModel : public IShapeModel
    {
    public:
...
#pragma region 基本控制
        ...
        static bool find(InputReMat image, InputRegion region, const std::vector<const GenericShapeModel*>& models, std::vector<MatchResult>& results);
